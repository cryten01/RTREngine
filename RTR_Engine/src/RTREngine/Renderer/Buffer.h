...
namespace RTREngine {
	...
	{
		None = 0, Float, Vec2, Vec3, Vec4, Mat3, Mat4, Int, Bool
	};
	...
	/*
	*	Abstract class for representing a single element within the buffer
	*/
	...
	/*
	*	Abstract class for representing the actual layout in the buffer
	*/
	class BufferLayout
	{
	public:
